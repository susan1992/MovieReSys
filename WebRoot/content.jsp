...
<html>
  ...
  <body  onload= "b()" style="background-color:white">
  	 <div><h1><em>Movies' World！ Enjoy！</em></h1></div>
		<div class="div_first">
   			<struts:iterator value="#request['hotmovies']" id="movie">
   				<div class="movie_one">
   					<img src="image/<struts:property value="#movie.key.name"/>.jpg"  width="144" height="98"><br/>
