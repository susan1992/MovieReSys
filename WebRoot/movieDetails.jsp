	...
	<body>
		<div>
			<div id="movieDetails_img" >
				...
				<ul class="bxslider">
	   		 		<struts:iterator value="#request['imageUrls']" id="imageurl">
	   		 			<li><div class="image_movieDetails"><img src="image/<struts:property value="#request['movieDetails'].name.jpg" />" width="100%" height="100%" ></div></li>
	   				 </struts:iterator>
				</ul>
			</div>
			<div class="div_left">
			...
			<div class="div_right">
				...
				<div id="click"></div>
				<div>
					<font face="Adobe 明體 Std L" color="#ff8080"><a href="javascript:void(0)" onclick="addToFavorites()">收藏这部电影</a></font>
				</div>
			</div>	
		</div>	
	</body>
